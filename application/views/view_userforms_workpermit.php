        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade in active" id="portlet_tab1">
            <div class="announcement-message">
              <p> If you are requesting for a Work Permit Form, kindly download the form we provided in this <?php $filename='Work_Permit.docx'; ?> <a href="<?php echo base_url(); ?>user_forms/download/<?php echo $filename; ?>" class="a-links">link</a> and answer it before uploading below. <span class="warning-user"> Please avoid uploading multiple form requests. Doing so will place you behind the queue. </span> Kindly attach the Work Permit Form you recently answered then we will contact you as soon as we have processed
