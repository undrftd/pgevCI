              ...
              <table class="table table-hover" id="tracking-table">
                ...
                <tr>
                    ...
                    <td class="action-button">
                      ...
                      <?php if($row->status != 0)
                      {
                        echo '<button type="button" class="btn btn-custom-3" data-href="' . base_url() . 'admin_forms/process_workpermit/' . $row->formid .'" data-toggle="modal" data-target="#delete-modal"> Set as Processed </button>';
                      }
                      ?>
                    </td>
                </tr>
