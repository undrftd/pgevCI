                ...
                <table class="table table-hover">
                  ...
                  <tr>
                      ...
                      <td class="action-button">
                        <button type="button" class="btn btn-custom-3" data-href="<?php echo base_url() . 'user_reservation/cancelreservation_clubhouse/' . $row->reservation_id; ?>" data-toggle="modal" data-target="#delete-modal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>  &nbsp;Cancel </button>
                      </td>
                  </tr>
                  <?php endforeach; ?>
