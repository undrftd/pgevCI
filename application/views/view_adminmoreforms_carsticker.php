  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-1 nopadding">
      ...
      <div class="information">
         ...
         <form action ="<?php echo site_url() . "admin_forms/save_application_carsticker/" . $carstickerdetails->formid; ?>" method="POST">
          ...
          <div class="form-group">
            ...
            <p> Contact Number </p>
            <input class="form-control" id="sel1" type="text" value="<?php echo $carstickerdetails->contactnum; ?>" readonly>
            ...
            <p> Status </p>
              <select name ="statusforms" class="form-control" id="sel1">
                <option value ="<?php echo $carstickerdetails->status; ?>" selected hidden> Choose Status</option>
