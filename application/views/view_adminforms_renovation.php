              ...
              <table class="table table-hover" id="tracking-table">
                ...
                <tr>
                    ...
                    <td class="action-button">
                      <a href="<?php echo base_url() . "admin_forms/download_renovation/" . $row->filename; ?>"><button type="button" class="btn btn-custom-2">Download</button></a>
                      <button type="button" class="btn btn-custom-3" data-href="<?php echo base_url() . 'admin_forms/delete_renovation/' . $row->filename; ?>" data-toggle="modal" data-target="#delete-modal"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>  Delete </button>
                    </td>
                </tr>
              <?php endforeach;?>
              </table>
