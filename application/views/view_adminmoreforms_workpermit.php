<div id="page-content-wrapper">
  ...
  <div class="header-style">
    <h1> Application Details - Work Permit</h1>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-1 nopadding">
      ...
      <div class="information">
         ...
         <form action ="<?php echo site_url() . "admin_forms/save_application_workpermit/" . $workpermitdetails->formid; ?>" method="POST">
          ...
          <div class="form-group">
            ...
            <br>
            <p> Name </p>
            <input class="form-control" id="sel1" type="text" value="<?php echo $workpermitdetails->firstname . " " . $workpermitdetails->middlename . " " . $workpermitdetails->lastname; ?>" readonly>

            <br>

            <p> Contact Number </p>
            <input class="form-control" id="sel1" type="text" value="<?php echo $workpermitdetails->contactnum; ?>" readonly>

            <br>

            <p> File Name </p>
            <input class="form-control" id="sel1" type="text" value="<?php echo $workpermitdetails->filename; ?>" readonly>

            <br>

            <p> Date Requested </p>
            <input class="form-control" id="sel1" type="text" value="<?php echo date("F d, Y", strtotime($workpermitdetails->date_requested)); ?>" readonly>
            
            <br>

            <p> Status </p>
              <select name ="statusforms" class="form-control" id="sel1">
                <option value ="<?php echo $workpermitdetails->status; ?>" selected hidden> Choose Status</option>
