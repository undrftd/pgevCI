                ...
                <table class="table table-hover">
                  ...
                  <tr>
                      ...
                      <?php if($row->reservation_status == 0) { echo "No Action Needed"; } else { echo '
                        <button type="button" class="btn btn-custom-3" data-href="' . base_url() . 'user_reservation/cancelreservation_courttwo/' . $row->reservation_id .'" data-toggle="modal" data-target="#delete-modal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>  &nbsp;Cancel </button>';
                      } ?>
                      </td>
                  </tr>
                  <?php endforeach; ?>
