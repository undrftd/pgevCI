        ...
        <form action="<?php echo site_url() . "admin_announcements/save_announcements/" . $select->post_id; ?>" method="POST">
          ...
          <fieldset id="myFieldset" disabled>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="user-message" placeholder="" name="post_content" rows="15" pattern=".{20,}" title="Announcement Content should at least be 20 characters long." required><?php echo $select->post_content; ?></textarea>
