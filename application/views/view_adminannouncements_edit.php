        ...
        <form action="<?php echo site_url() . "admin_announcements/save_announcements/" . $select->post_id; ?>" method="POST">
          ...
          <fieldset id="myFieldset" disabled>
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="sel1" type="text" name="post_title" value="<?php echo htmlentities($select->post_title); ?>" pattern=".{8,}" title="Announcement Title should at least be 8 characters long." required>
              ...
              <textarea class="form-control" id="user-message" placeholder="" name="post_content" rows="15" pattern=".{20,}" title="Announcement Content should at least be 20 characters long." required><?php echo htmlentities($select->post_content); ?></textarea>
