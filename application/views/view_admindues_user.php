          ...
          <div class="modal-content">
            ...
            <div class="signin">
                <div class="modal-body text-center">
                    ...
                    <a href="<?php echo base_url(); ?>admin_dues/deact_users"><button type="submit" class="btn btn-custom-1">Yes</button></a>
                    <button type="button" class="btn btn-custom" data-dismiss="modal">Cancel</button>
                </div>
            </div>
    ...
    <div class="portlet-body">
      ...
      <div class="row">
        ...
        <ul class="dues-buttons">
          ...
          <li>
            <a href="<?php echo site_url('admin_export/exportduesadmin'); ?>">
            Export to Excel </a>
          </li>
          ...
              <li><a href="#" data-toggle="modal" data-target="#clear-modal">Clear Records</a></li><br>
              ...
              <li><a href="<?php echo site_url('admin_export/exportdueshomeowner'); ?>">Export to Excel </a></li> <br>
            </ul>
          </li>
        </ul>
