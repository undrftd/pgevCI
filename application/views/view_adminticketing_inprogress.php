<div id="page-content-wrapper">
  ...
  <div class="header-style nopadding">
    <h1> Ticketing  <?php if($this->uri->segment(2) == 'progress_priorityone') { echo "- Priority 1"; } else if($this->uri->segment(2) == 'progress_prioritytwo') { echo "- Priority 2"; } else { echo " "; } ?>
      <span class="dropdown">
        <a class="dropdown-toggle sort-button" type="button" data-toggle="dropdown"> Filter list <span class="caret"></span> </a>
        <ul class="dropdown-menu">
          <li><a href="<?php echo site_url('admin_ticketing/progress_tickets'); ?>">All Tickets</a></li>
          <li><a href="<?php echo site_url('admin_ticketing/progress_priorityone'); ?>">Priority 1</a></li>
          <li><a href="<?php echo site_url('admin_ticketing/progress_prioritytwo'); ?>">Priority 2</a></li>
        </ul>
      </span>
    </h1>
  </div><br>
