        ...
        <form action="<?php echo base_url() ."admin_accounts/accupdate_admin/" . $view->userid ;?>" method="POST">
          ...
          <div class="form-group">
            <h4> User Credentials <small class="admin-fields"> All fields are required </small> </h4>
                ...
                <p> Birthdate </p>
                <input name="birthdate" class="form-control" id="sel1" type="text" placeholder="" value="<?php echo htmlentities($view->birthdate); ?>" pattern="[a-z A-Z ]{2,30}" title="Middle Name must include a minimum of 2 and a maximum of 30 alphabetical characters only." required>
                <p class="error"><?php echo form_error('middlemname'); ?></p>
                <br>
