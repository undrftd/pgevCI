    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 nopadding">
        ...
        <div class="information">
          ...
          <form action="<?php echo site_url();?>user_ticketing/send_complaint" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select name ="type" class="form-control" id="sel1" autofocus required>
                <option value="" selected hidden>Type of Complaint</option>
                <option value="CMP">Malfunctioning Post Lights</option>
                <option value="CBD">Blocked Drainage</option>
                <option value="CSC">Electrical Short Circuit</option>
                <option value="CMD">Monthly Dues</option>
                <option value="COT">Other</option>
              </select>
