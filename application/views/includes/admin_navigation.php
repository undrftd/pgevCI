     <div id="wrapper">
        <div id="sidebar-wrapper">
          <ul class="sidebar-nav text-center">
            ...
            <li>
                <a href="<?php echo site_url("admin_accounts/homeowner"); ?>" class="<?php if($this->uri->segment(2) == 'homeowner' OR $this->uri->segment(2) == 'administrator' OR $this->uri->segment(2) == 'deactivated' OR $this->uri->segment(2) == 'adduser') { echo 'active'; } ?>">Accounts</a>
            </li>
            <li>
