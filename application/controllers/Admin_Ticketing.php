...
class Admin_Ticketing extends MY_Controller {
    ...
    function newtickets_priorityone()
    {
        $config['base_url'] = site_url('admin_ticketing/newtickets_priorityone');
        $config['total_rows'] = $this->model_ticketing->countnew_priorityone();
        $config['per_page'] =  20;
        $config['num_links'] = 5;
        $config['use_page_numbers'] = FALSE;
        $config['full_tag_open'] = "<ul class='pagination'>";
        ...
        $data['reserve'] = $this->model_reservation->count_allnewreserve();
        $data['forms'] = $this->model_forms->count_allnewforms();
        $data['result'] = $this->model_ticketing->getnew_priorityone($config['per_page'], $this->uri->segment(3));
        $this->template->load('admin_template', 'view_adminticketing_new', $data);
    }

    function newtickets_prioritytwo()
    {
        $config['base_url'] = site_url('admin_ticketing/newtickets_prioritytwo');
        $config['total_rows'] = $this->model_ticketing->countnew_prioritytwo();
        $config['per_page'] =  20;
        $config['num_links'] = 5;
        $config['use_page_numbers'] = FALSE;
        $config['full_tag_open'] = "<ul class='pagination'>";
        ...
        $data['reserve'] = $this->model_reservation->count_allnewreserve();
        $data['forms'] = $this->model_forms->count_allnewforms();
        $data['result'] = $this->model_ticketing->getnew_prioritytwo($config['per_page'], $this->uri->segment(3));
        $this->template->load('admin_template', 'view_adminticketing_new', $data);
    }

    function progress_priorityone()
    {
        $config['base_url'] = site_url('admin_ticketing/progress_priorityone');
        $config['total_rows'] = $this->model_ticketing->countprogress_priorityone();
        $config['per_page'] =  20;
        $config['num_links'] = 5;
        $config['use_page_numbers'] = FALSE;
        $config['full_tag_open'] = "<ul class='pagination'>";
        ...
        $data['reserve'] = $this->model_reservation->count_allnewreserve();
        $data['forms'] = $this->model_forms->count_allnewforms();
        $data['result'] = $this->model_ticketing->getprogress_priorityone($config['per_page'], $this->uri->segment(3));
        $this->template->load('admin_template', 'view_adminticketing_inprogress', $data);
    }

    function progress_prioritytwo()
    {
         $config['base_url'] = site_url('admin_ticketing/progress_prioritytwo');
        $config['total_rows'] = $this->model_ticketing->countprogress_prioritytwo();
        $config['per_page'] =  20;
        $config['num_links'] = 5;
        $config['use_page_numbers'] = FALSE;
        $config['full_tag_open'] = "<ul class='pagination'>";
        ...
        $data['reserve'] = $this->model_reservation->count_allnewreserve();
        $data['forms'] = $this->model_forms->count_allnewforms();
        $data['result'] = $this->model_ticketing->getprogress_prioritytwo($config['per_page'], $this->uri->segment(3));
        $this->template->load('admin_template', 'view_adminticketing_inprogress', $data);
    }
